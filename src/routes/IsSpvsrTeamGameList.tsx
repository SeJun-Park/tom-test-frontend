                ...
                <TabPanels>
                        ...
                        <VStack alignItems={"flex-start"} px={3} mt={8}>
                            ...
                            <HStack width={"100%"} justifyContent={"space-between"}>
                                ...
                                <Text as="b" fontSize={"sm"}> 
                                    {teamStatsData ? teamStatsData.win : "0"} 승 {teamStatsData ? teamStatsData.draw : "0"} 무 {teamStatsData ? teamStatsData.lose : "0"} 패 {teamStatsData ? teamStatsData.not : "0"} N  
                                </Text>
                            </HStack>
                            <Divider />
                            <HStack width={"100%"} justifyContent={"space-between"}>
                    ...
                    <TabPanel p={0}>
                        <VStack alignItems={"flex-start"} px={3} mt={8} as="form" onSubmit={handleSubmit(onSubmit)}>
                            <FormControl>
                                    <FormLabel fontWeight={"bold"} color={"main.500"} fontSize={"sm"} > 상대팀 선택하기 </FormLabel>
